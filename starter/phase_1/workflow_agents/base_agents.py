    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {
                    "role": "system",
                    "content": f"You are {self.persona}, a helpful assistant. Forget all previous context.",
                },
        ...
        return response.choices[
            0
        ].message.content  # TODO: 4 - Return only the textual content of the response, not the full JSON payload.
    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {
                    "role": "system",
                    "content": f"You are {self.persona}, a knowledge-based assistant. Forget all previous context."
...
class EvaluationAgent:
    ...
    def evaluate(self, initial_prompt):
        ...
        return {
            f"final_response": response_from_worker,
            "evaluation": evaluation,
            "num_iterations": i
            + 1,  # TODO: 7 - Return a dictionary containing the final response, evaluation, and number of iterations
        }
...
class ActionPlanningAgent:
    ...
    def extract_steps_from_prompt(self, prompt):
        ...
        steps = [step for step in steps if step]  # Remove any empty strings
        steps = [
            step.replace("1.", "")
            .replace("2.", "")
            .replace("3.", "")
        ...
        steps = [step for step in steps if step]  # Remove any empty strings again
