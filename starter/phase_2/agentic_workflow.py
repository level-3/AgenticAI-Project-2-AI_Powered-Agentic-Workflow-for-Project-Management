...
print(f"Product Spec: {product_spec}\n")
...
# Instantiate the product_manager_evaluation_agent
    ...
    agents=[
        {
            ...
            "description": "Routes to the Product Manager support function",
            "func": lambda x: product_manager_support_function(x),
        },
        {
            "name": "Program Manager",
            "description": "Routes to the Program Manager support function",
            "func": lambda x: program_manager_support_function(x),
        },
        {
            "name": "Development Engineer",
            "description": "Routes to the Development Engineer support function",
